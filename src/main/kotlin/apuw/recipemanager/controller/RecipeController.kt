...
@Tag(
    ...
    description =
        "Endpoints for managing recipes, including fetching, creating, updating," +
...
class RecipeController(
    ...
    @Operation(
        ...
        description =
            "Retrieve a list of all available recipes. This endpoint returns the basic details of each recipe " +
    ...
    @Operation(
        ...
        description =
            "Create a new recipe by providing the necessary recipe details. " +
    ...
    @Operation(
        ...
        description =
            "Retrieve the details of a recipe by its unique ID. " +
    ...
    @Operation(
        ...
        description =
            "Update the details of an existing recipe by its unique ID. " +
    ...
    @Operation(
        ...
        description =
            "Delete an existing recipe by its unique ID. " +
